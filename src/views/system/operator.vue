<template>
  <div style="background:#fff ;padding:25px;position: relative">
    ...
    <!--表格-->
    <a-table size="middle" :scroll="{ x: 1100}" :columns="columns" :dataSource="loadDatas" :loading="loading" :pagination="pagination" :rowSelection="{type:'checkbox', selectedRowKeys: selectedRowKeys, onChange: updateSelect }">

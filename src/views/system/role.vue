<template>
  <div style="background:#fff ;padding:25px;position: relative">
    ...
    <!--表格-->
    <a-table size="middle" :scroll="{ x: 800}" :columns="columns" :dataSource="loadDatas" :loading="loading" :pagination="pagination" :rowSelection="{type:'radio', selectedRowKeys: selectedRowKeys, onChange: updateSelect }">
...
const columns = [
  { title: '角色名称', width: 120, dataIndex: 'roleName', fixed: 'left' },
  {
    title: '角色类型',
    width: 120,
    dataIndex: 'roleType',
